...
You can run [this notebook](https://github.com/DCS-training/EffectiveDataVisualisation/blob/main/python_viz.ipynb) either via Noteable, via Google Colab, or on your own device. 
